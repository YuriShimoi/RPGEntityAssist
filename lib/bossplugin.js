class BossPlugin extends EntityPluginBase {
    ...
    //#region [GET/SET]
    get stage() { return this.__stage__ }
    set stage(st) { this.__stage__ = st }
    get nextStage() { return this.stage !== ""? this.__stages__[this.__stages__[this.stage]?.next_stage] | null: null }
    //#endregion
    ...
    addStage(stage_id, values, next_stage=null) {
        ...
        this.__stages__[stage_id] = new BossStageBase(this.stage_id, values, next_stage);
